...
from version_prueba.apps.audio.main import app as audio_app
from version_prueba.apps.images.main import app as images_app
from version_prueba.apps.ollama.main import (
    app as ollama_app,
    get_all_models as get_ollama_models,
    generate_chat_completion as generate_ollama_chat_completion,
    GenerateChatCompletionForm,
)
from version_prueba.apps.openai.main import (
    app as openai_app,
    generate_chat_completion as generate_openai_chat_completion,
    get_all_models as get_openai_models,
    get_all_models_responses as get_openai_models_responses,
)
from version_prueba.apps.retrieval.main import app as retrieval_app
from version_prueba.apps.retrieval.utils import get_sources_from_files, rag_template
from version_prueba.apps.socket.main import (
    app as socket_app,
    periodic_usage_pool_cleanup,
    get_event_call,
    get_event_emitter,
)
from version_prueba.apps.webui.internal.db import Session
from version_prueba.apps.webui.main import (
    app as webui_app,
    generate_function_chat_completion,
    get_all_models as get_version_prueba_models,
)
from version_prueba.apps.webui.models.functions import Functions
from version_prueba.apps.webui.models.models import Models
from version_prueba.apps.webui.models.users import UserModel, Users
from version_prueba.apps.webui.utils import load_function_module_by_id
from version_prueba.config import (
    CACHE_DIR,
    CORS_ALLOW_ORIGIN,
    DEFAULT_LOCALE,
...
from version_prueba.constants import TASKS
from version_prueba.env import (
    CHANGELOG,
    GLOBAL_LOG_LEVEL,
    SAFE_MODE,
    SRC_LOG_LEVELS,
...
from version_prueba.utils.misc import (
    add_or_update_system_message,
    get_last_user_message,
    prepend_to_first_user_message_content,
)
from version_prueba.utils.oauth import oauth_manager
from version_prueba.utils.payload import convert_payload_openai_to_ollama
from version_prueba.utils.response import (
    convert_response_ollama_to_openai,
    convert_streaming_response_ollama_to_openai,
)
from version_prueba.utils.security_headers import SecurityHeadersMiddleware
from version_prueba.utils.task import (
...
from version_prueba.utils.tools import get_tools
from version_prueba.utils.utils import (
    decode_token,
    get_admin_user,
    get_current_user,
...
from version_prueba.utils.access_control import has_access
...
async def get_all_base_models():
    ...
    version_prueba_models = await get_version_prueba_models()

    models = version_prueba_models + openai_models + ollama_models
    return models
    ...
    try:
        ...
        async with aiohttp.ClientSession(timeout=timeout, trust_env=True) as session:
            async with session.get(
                "https://api.github.com/repos/version-prueba/version-prueba/releases/latest"
            ) as response:
...
async def get_manifest_json():
    return {
        ...
        "description": "Version Prueba is an open, extensible, user-friendly interface for AI that adapts to your workflow.",
        "start_url": "/",
        "display": "standalone",
