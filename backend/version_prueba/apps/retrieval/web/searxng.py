...
import requests
from version_prueba.apps.retrieval.web.main import SearchResult, get_filtered_results
...
def search_searxng(
    ...
    **kwargs,
    ...
    response = requests.get(
        query_url,
        headers={
            "User-Agent": "Version Prueba (https://github.com/version-prueba/version-prueba) RAG Bot",
            "Accept": "text/html",
