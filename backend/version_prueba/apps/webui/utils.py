...
from version_prueba.apps.webui.models.tools import Tools
from version_prueba.config import FUNCTIONS_DIR, TOOLS_DIR
...
def replace_imports(content):
    ...
    """
    replacements = {
        "from utils": "from version_prueba.utils",
        "from apps": "from version_prueba.apps",
        "from main": "from version_prueba.main",
        "from config": "from version_prueba.config",
    }
